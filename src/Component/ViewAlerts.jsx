...
const ViewAlerts = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('/viewalerts');
                    ...
                    <div className="w-full flex flex-col">
                        <table className="hidden md:inline-block">
                            ...
                            {weaponData && weaponData.length > 0 ? (
                                ...
                                <tr className="p-2 text-black dark:text-white bg-white dark:bg-slate-700 shadow-sm shadow-gray-400 dark:shadow-none w-[100%] rounded-md">
