...
const Home = () => {
    ...
    <div className="bg-slate-100 dark:bg-slate-800 min-h-screen min-w-screen">
        ...
        <div className="mx-auto py-28 md:py-20 flex flex-col-reverse md:flex-row-reverse gap-4 w-[100%]">
            <form onSubmit={handleLogin} className="p-5 flex flex-col gap-4 bg-transparent w-full md:w-[30%] rounded-md shadow-sm shadow-gray-200">
                ...
                <h2 className="text-3xl font-bold text-center text-blue-600  dark:text-white">LOGIN</h2>
                <div className="flex flex-col gap-2">
                    <input type="email" id="email" name="email" placeholder="Email" className="px-4 py-2 w-full rounded-md bg-transparent bg-white dark:bg-slate-700 outline-none text-black dark:text-white border border-blue-600 dark:border-0" value={securityData.email} onChange={handleInputChange}/>

                    <input type="password" id="password" name="password" placeholder="Password" className="px-4 py-2 w-full rounded-md bg-transparent bg-white dark:bg-slate-700 outline-none text-black dark:text-white border border-blue-600 dark:border-0" value={securityData.password} onChange={handleInputChange}/>
                </div>
                ...
                <span className="text-black dark:text-white font-bold text-center">Don&apos;t have an Account ? <a href="/register" className="text-blue-600 dark:text-yellow-400">Register</a></span>
            </form>
            <div className="p-10 hidden md:flex md:flex-col items-start justify-center w-full md:w-[70%]">
                <div className="mb-8 flex justify-center">
                    <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 dark:text-white ring-1 ring-gray-900/10 dark:ring-white hover:ring-gray-900/20 dark:hover:ring-white">
                        Announcing our Netra AI.{' '}
                ...
                Intelligent CCTV Analytics for Secure Environments
                </h1>
                <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300">
                Empowering Security Personnel with YOLOv3-Driven Threat Identification
                </p>
